    ...
    "professionalExperience": [
        {
            ...
            "responsiblity": [
                ...
                "Provisioned Azure resources of different providers Compute, Network, Service Fabric, Application gateway using ARM templates and implemented, maintained Dev, Test, UAT and Production environments leveraging infrastructure as code using Azure ARM templates (Infrastructure as code, JSON / YAML config).",
                ...
                "Build and Installed web servers, virtual machines, virtual security groups through Azure Resource Manager (ARM) templates. Worked on Azure VPN-Point to Site, Azure Custom security, endpoint security and firewall.",
                ...
                "Deployed and managed containerized applications using AKS hosted Kubernetes environment. Created resources and infrastructure inside Azure Kubernetes clusters through deployment and service manifest files.",
                ...
                "Used Azure Monitor to measure the performance of applications and services, collected data from monitored resources using Azure Monitor Metrics.",
                "Wrote Ansible playbooks to push out new configuration or confirm the configuration of remote system. Defined tasks to Ansible modules for roles and playbooks.",
        ...
        },
        {
            ...
            "responsiblity": [
                ...
                "Utilized Source Tree GUI client tool to clone the Bitbucket repositories into local and created pull requests to merge the developed source code into Develop branches.",
        ...
        },
        {
            ...
            "responsiblity": [
                ...
                "Tested GitHub Actions Workflow scripts to trigger Azure DevOps Pipelines based on the actions in the repository.",
